...
module moore ( clk, n_rst, i, o );
  ...
  DFFSR \state_reg[0]  ( .D(newstate[0]), .CLK(clk), .R(n_rst), .S(1'b1), .Q(
        state[0]) );
  DFFSR \state_reg[1]  ( .D(newstate[1]), .CLK(clk), .R(n_rst), .S(1'b1), .Q(
        state[1]) );
  DFFSR \state_reg[2]  ( .D(newstate[2]), .CLK(clk), .R(n_rst), .S(1'b1), .Q(
        state[2]) );
  INVX1 U21 ( .A(n16), .Y(o) );
  NOR2X1 U22 ( .A(n17), .B(n18), .Y(newstate[2]) );
  OAI21X1 U23 ( .A(n19), .B(n16), .C(n20), .Y(newstate[1]) );
  ...
  NOR2X1 U30 ( .A(n25), .B(n26), .Y(newstate[0]) );
